use super::interconnect::interconnect::Interconnect;
use super::opcode::{OPCODE_NAME_LUT, CB_OPCODE_NAME_LUT, OPCODE_LENGTHS};
use std::string::String;

fn disassembler_opcode(opcode: u8, program_counter: u16, interconnect: &mut Interconnect) -> String {
    ...
    match opcode_length {
        ...
        3 => {
            let low = interconnct.read(program_counter) as u16;
